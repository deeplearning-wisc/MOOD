...
def main(
    ...
    def step(engine, batch):
        ...
        #from utils_flop import measure_model
        #print(measure_model(model,32,32))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--download", default = True, help="downloads dataset")
